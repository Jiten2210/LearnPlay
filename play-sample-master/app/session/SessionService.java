...
import play.Logger;
import privilege.PrivilegeModel;
import privilege.PrivilegeRequestForm;
...
public class SessionService {
    ...
    public boolean assignSessionToUser(ObjectId userId, String session, PrivilegeRequestForm inputParam) {
        try {
            ...
            sessionModel.setEmail(inputParam.getEmail());
